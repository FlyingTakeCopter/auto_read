...
while True:
    ...
    os.system("adb shell input tap 600 %d" % (y + 280 / 2))  # 按住滑动
    # 等待固定时间
    # time.sleep(2)
    # 从新开始
    continue
    ...
    # os.system("adb shell screencap -p /sdcard/temp.jpg")#截图
    # os.system("adb pull /sdcard/temp.jpg E:/wechat_jump/temp.jpg")#推送
    # os.system("adb shell input swipe 10 10 10 10 %d" % int(restime))#按住滑动
    # time.sleep(1.5)